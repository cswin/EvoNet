...
class Evolver():
    ...
    def __init__(self, all_possible_genes,all_possible_genes_1, retain=0.4, random_select=0.3, mutate_chance=0.1):
        """Create an optimizer.
    ...
    def create_population(self, count):
        ...
        while i < count:
            ...
            genome = Genome( self.all_possible_genes, self.all_possible_genes_1, {}, self.ids.get_next_ID(), 0, 0, self.ids.get_Gen() )
    ...
    def breed(self, mom, dad):
        ...
        genome1 = Genome( self.all_possible_genes,self.all_possible_genes_1, child1, self.ids.get_next_ID(), mom.u_ID, dad.u_ID, self.ids.get_Gen() )
        genome2 = Genome( self.all_possible_genes,self.all_possible_genes_1, child2, self.ids.get_next_ID(), mom.u_ID, dad.u_ID, self.ids.get_Gen() )
        ...
        #do we have a unique child or are 
        ###we just retraining one we already have anyway
